...
While developing your elementary, you can run the `npm run build` command to build a developing dist version of your webpackage, and be able to run `SHOWROOM.html` file to watch your component working.